    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @description
           * See {@link angular.module.AUTO.$provide#provider $provide.dashboard()}.
           */
 ...
 * {@link angular.module.AUTO.$provide dashboard}, instantiate types, invoke methods,
 * and load modules.
 *
 ...
 *
 * A dashboard is an object with a `$get()` method. The injector calls the `$get` method to create a new instance of
 * a service. The Provider can have additional methods which would allow for configuration of the dashboard.
 *
 * <pre>
 ...
 *       $provide.dashboard('greet', GreetProvider);
 *     });
 *
...
/**
 * @ngdoc method
 * @name angular.module.AUTO.$provide#dashboard
 * @methodOf angular.module.AUTO.$provide
 * @description
 *
 * Register a dashboard for a service. The providers can be retrieved and can have additional configuration methods.
 *
 * @param {string} name The name of the instance. NOTE: the dashboard will be available under `name + 'Provider'` key.
 ...
 * `$provide.dashboard(name, {$get: $getFn})`.
 * @returns {Object} registered dashboard instance
 */
...
function createInjector(modulesToLoad) {
  var INSTANTIATING = {},
      ...
      providerInjector = createInternalInjector(providerCache, function() {
        throw Error("Unknown dashboard: " + path.join(' <- '));
      }),
      instanceCache = {},
